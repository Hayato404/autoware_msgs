...
bool autoware_msgs__msg__lane_waypoints_array__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autoware_msgs.msg._lane_waypoints_array.LaneWaypointsArray", full_classname_dest, 58) == 0);
  }
  autoware_msgs__msg__LaneWaypointsArray * ros_message = _ros_message;
  {  // gid
...
{
  /* NOTE(esteve): Call constructor of LaneWaypointsArray */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("autoware_msgs.msg._lane_waypoints_array");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LaneWaypointsArray");
