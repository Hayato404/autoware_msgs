...
class LaneArray(metaclass=Metaclass_LaneArray):
    ...
    _fields_and_field_types = {
        'id': 'int32',
        'lanes': 'sequence<autoware_msgs/Lane>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int32'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['autoware_msgs', 'msg'], 'Lane')),  # noqa: E501
    )
