...
bool autoware_msgs__msg__lane__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // increment
    ...
    ros_message->increment = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // lane_id
  ...
  {  // closest_object_distance
    PyObject * field = PyObject_GetAttrString(_pymsg, "closest_object_distance");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->closest_object_distance = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // closest_object_velocity
    PyObject * field = PyObject_GetAttrString(_pymsg, "closest_object_velocity");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->closest_object_velocity = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // is_blocked
...
PyObject * autoware_msgs__msg__lane__convert_to_py(void * raw_ros_message)
{
  ...
  {  // increment
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->increment);
    {
  ...
  {  // closest_object_distance
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->closest_object_distance);
    {
      int rc = PyObject_SetAttrString(_pymessage, "closest_object_distance", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // closest_object_velocity
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->closest_object_velocity);
    {
      int rc = PyObject_SetAttrString(_pymessage, "closest_object_velocity", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
