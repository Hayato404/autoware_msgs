...
#ifndef AUTOWARE_MSGS__MSG__DETAIL__LANE_WAYPOINTS_ARRAY__STRUCT_H_
#define AUTOWARE_MSGS__MSG__DETAIL__LANE_WAYPOINTS_ARRAY__STRUCT_H_
...
/// Struct defined in msg/LaneWaypointsArray in the package autoware_msgs.
typedef struct autoware_msgs__msg__LaneWaypointsArray
{
  /// Global ID
  int32_t gid;
  /// Local ID
...
// Struct for a sequence of autoware_msgs__msg__LaneWaypointsArray.
typedef struct autoware_msgs__msg__LaneWaypointsArray__Sequence
{
...
#endif  // AUTOWARE_MSGS__MSG__DETAIL__LANE_WAYPOINTS_ARRAY__STRUCT_H_
