...
#ifndef AUTOWARE_MSGS__MSG__DETAIL__LANE_WAYPOINTS_ARRAY__TRAITS_HPP_
#define AUTOWARE_MSGS__MSG__DETAIL__LANE_WAYPOINTS_ARRAY__TRAITS_HPP_
...
inline std::string to_yaml(const LaneWaypointsArray & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const autoware_msgs::msg::LaneWaypointsArray & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const autoware_msgs::msg::LaneWaypointsArray & msg)
{
  return autoware_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<autoware_msgs::msg::LaneWaypointsArray>()
{
  return "autoware_msgs::msg::LaneWaypointsArray";
}

template<>
inline const char * name<autoware_msgs::msg::LaneWaypointsArray>()
{
  return "autoware_msgs/msg/LaneWaypointsArray";
}

template<>
struct has_fixed_size<autoware_msgs::msg::LaneWaypointsArray>
...
template<>
struct has_bounded_size<autoware_msgs::msg::LaneWaypointsArray>
...
template<>
struct is_message<autoware_msgs::msg::LaneWaypointsArray>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // AUTOWARE_MSGS__MSG__DETAIL__LANE_WAYPOINTS_ARRAY__TRAITS_HPP_
